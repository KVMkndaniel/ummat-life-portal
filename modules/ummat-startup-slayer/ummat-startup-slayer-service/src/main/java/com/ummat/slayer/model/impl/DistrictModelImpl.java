...
public class DistrictModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"active_", Types.BOOLEAN}, {"regionCode", Types.VARCHAR},
	...
	public static final String TABLE_SQL_CREATE =
		"create table District (uuid_ VARCHAR(75) null,districtId LONG not null primary key,regionId LONG,name VARCHAR(75) null,active_ BOOLEAN,regionCode VARCHAR(75) null,companyId LONG,userId LONG,createDate DATE null,modifiedDate DATE null)";
	 ...
	 */
	@Deprecated
	public static final long REGIONCODE_COLUMN_BITMASK = 2L;

	/**
	 * @deprecated As of Athanasius (7.3.x), replaced by {@link #getColumnBitmask(String)}
	 */
	@Deprecated
	public static final long REGIONID_COLUMN_BITMASK = 4L;
	 ...
	 */
	@Deprecated
	public static final long DISTRICTID_COLUMN_BITMASK = 16L;
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put("regionCode", District::getRegionCode);
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"regionCode",
				(BiConsumer<District, String>)District::setRegionCode);
			attributeSetterBiConsumers.put(
				"companyId",
	...
	static {
		...
		columnBitmasks.put("regionCode", 32L);
