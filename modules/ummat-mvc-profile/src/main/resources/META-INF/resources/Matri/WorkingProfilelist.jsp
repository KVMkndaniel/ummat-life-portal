		...
		<div class="search-box text-white">
			...
			<div class="form-row">
				<div class="col-6 col-md-3 mb-2">
					...
					</select> <input type="hidden" id="genderhidden" value="" /> <input
						type="hidden" id="jamathhidden" value="" /> <input type="hidden"
						id="statehidden" value="" /> <input type="hidden" id=disthidden
						value="" /> <input type="hidden" id="areahidden" value="" /> <input
						type="hidden" id="useridhidden" value="" /> <input type="hidden"
						id="languagehidden" value="" /> <input type="hidden"
						id="agehidden" value="" /> <input type="hidden"
						id="professionhidden" value="" />
				...
				<div class="col-6 col-md-3 mb-2">
					<select name="state" class="form-control" label="Select state"
						id="selectedState">
            ...
            function(data) {
				...
				<div class="col-6 col-md-3 mb-2">
					<select name="area" class="form-control" label="Area"
						id="availableLocality" onchange="selectArea(this)">
...
<div class="contact-directory-list">
    <ul class="card-list pager profile-container row" id="userList">
        <% 
				...
				<li class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
					<div class="contact-directory-box">
						<div class="contact-dire-info text-center">
							<div class="contact-avatar">
								<span> <img
									src="<%= userItems.getPortraitURL(themeDisplay) %>"
									alt="UserImage">
								</span>
							</div>
							<div class="contact-name">
								<h4>
									Name :
									<%= userItems.getFullName() %></h4>

								<div class="work text-success">
									<i class="icon-copy fa fa-group"></i> Jamath :
									<%= matrimonyUser.getJamath() %> <br>
									<span class="work text-secondary"> Job : <%= userItems.getJobTitle()%></span>
								</div>
							</div>
                        ...
                        %>
							<div class="profile-sort-desc">
								<span class="badge badge-pill">Created: <em><%=formattedDate %></em>
								</span>
								<ul class="clearfix" id="sa-error">
									<li><a href="#" class="btn" data-bgcolor="rgb(231 50 50)" 
										data-color="#ffffff"><i class="fa fa icon-copy fi-heart"></i></a></li>
								</ul>
							</div>
						</div>
						<% 
                    ...
                    %>
						<div class="view-contact">
							<a href="<%= informationRenderURL %>">View Profile</a>
						</div>
					</div>
				</li>
            ...
            on: {
                success: function() {
                    ...
                    A.Array.each(filteredUsers, function(user) {
                         userListHtml += '<li class="col-xl-4 col-lg-4 col-md-6 col-sm-12">' +
					    '<div class="contact-directory-box">' +
					        '<div class="contact-dire-info text-center">' +
					            '<div class="contact-avatar">' +
					                '<span><img src="' + user.portraitURL + '" alt="UserImage"></span>' +
					            '</div>' +
					            '<div class="contact-name">' +
					                '<h4>Name : ' + user.fullName + '</h4>' +
					                '<div class="work text-success">' +
					                    '<i class="icon-copy fa fa-group"></i> Jamath : ' + user.Jamath + '<br>' +
					                    '<span class="work text-secondary"> Job : ' + user.jobTitle + '</span>' +
					                '</div>' +
					            '</div>' +
					            '<div class="profile-sort-desc">' +
					                '<span class="badge badge-pill">Created: <em>' + user.createDate + '</em></span>' +
					                '<ul class="clearfix" id="sa-error">' +
					                    '<li>' +
					                        '<a href="#" class="btn" data-bgcolor="rgb(231 50 50)" data-color="#ffffff">' +
					                            '<i class="fa fa icon-copy fi-heart"></i>' +
					                        '</a>' +
					                    '</li>' +
					                '</ul>' +
					            '</div>' +
